...
export const register = async (req, res) => {
    try {
        const db = getDB();
        // 1. LOOK FOR familyCode INSTEAD OF parentName
        ...
        // 2. LINK THE CHILD USING THE SECRET CODE
        if (role === 'child') {
            ...
            // 3. GENERATE A RANDOM 6-DIGIT CODE FOR THE PARENT
        ...
        const newUser = {
            ...
            familyId: familyId,
            familyCode: generatedFamilyCode // Attach code to the DB
        };
        ...
        // 4. SEND THE CODE BACK TO THE FRONTEND
...
export const login = async (req, res) => {
    try {
        ...
        // 5. SEND THE CODE BACK ON LOGIN TOO
